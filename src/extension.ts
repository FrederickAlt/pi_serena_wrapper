...
const TOOLS: (ToolEntry & { execute: ExecuteFn })[] = [
  ...
  },
  {
    ...
    guidelines: [
      ...
      "The default kinds filter excludes noisy leaf kinds (Property, Field, Variable, File, Package, String, Number, Boolean, Array, Object, Key, Null, Operator, Unknown, Constant, EnumMember). Override with kinds to include them or narrow further.",
