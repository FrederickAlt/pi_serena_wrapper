...
| `get_document_symbols` | Indented text tree of symbols in a file | `ls.request_document_symbols`, recursive formatting | `tool-contracts.json:get_document_symbols` |
